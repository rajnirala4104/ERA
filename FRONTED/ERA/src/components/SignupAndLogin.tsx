   ...
   return (
      <React.Fragment>
         <Suspense fallback={<LoaderSpinner />}>
            <section
               style={{
                  background: `url(${allImages.loginBg}) center center/cover`,
               }}
               ...
               >
                  <div className="sideImg hidden lg:flex flex-col justify-between items-center w-[45%] h-[100%] ">
                     <h1
                        ...
                        className="text-5xl mt-20  text-[#0c644e] cursor-default"
                     >
                        ERA
                     </h1>
                     <img
                        loading="lazy"
                        src={allImages.loginSVG}
                        className="w-[70%] mb-4"
                        alt="era"
                     />
                  </div>
                  ...
                  <div className="w-[50%] h-[87%] flex justify-center items-center flex-col ">
                     ...
                     <span
                        onClick={() => setLoginDesign(!loginDesign)}
                        className="text-blue-700 font-semibold  hover:underline cursor-pointer"
                     >
                        {loginDesign ? "Don't have account" : "have account"}
                     </span>
                  </div>
               </div>
            </section>
