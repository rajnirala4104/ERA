...
const PostCreatePopupForm: React.FC = () => {
   ...
   const [allPostsAndThoughtPosts, setAllPostsAndThoughtPosts] =
   ...
   console.log(allPostsAndThoughtPosts);
               ...
               <div className="flex flex-col w-[60%] h-[80%] justify-center relative items-center bg-white rounded-md">
                  ...
                  <div className="my-2 flex flex-col justify-start items-center w-full h-full">
                     ...
                     >
                        <form
                           onKeyDown={(e) =>
                              e.key === "Enter" ? ThoughtPostSubmitHandler : ""
                           }
                     ...
                     <div className="my-2">
                        ...
                        >
                           {!thoughtPostForm ? "ThoughtPost" : "Post"}
                        </span>
                     </div>
                  </div>
               </div>
